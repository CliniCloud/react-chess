...
class Chess extends React.Component {
  ...
  renderNextMovs(x, y, nextMovPos, attacks){
    if(nextMovPos && nextMovPos.x === x && nextMovPos.y === y){
        console.log('nextMovPos.x', nextMovPos.x, typeof nextMovPos.x);
        console.log('nextMovPos.y', nextMovPos.y, typeof nextMovPos.y);
