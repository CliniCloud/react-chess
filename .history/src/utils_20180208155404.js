...
module.exports.getPawnOptions = function(piece){
    ...
    const attactOpt = this.getColumn(piecePositions.x + 1)
    const attactOpt2 = this.getColumn(piecePositions.x - 1)
    const movement = this.getColumn(piecePositions.x)

    console.log('QQQQQQQQQQQQQQQQ', movement, attactOpt, attactOpt2);
