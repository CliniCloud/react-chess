...
class Chess extends React.Component {
  ...
  handleDragStop(evt, drag) {
    ...
    if (dragFrom.pos !== dragTo.pos && !this.isSameTeamPiece(draggingPiece, dragTo.pos)) {
  ...
  isSameTeamPiece(draggingPiece, dragToPos){
      const positionedPiece = this.findPieceAtPosition(dragToPos)
      console.log('draggingPiece', draggingPiece);
      console.log('positionedPiece', positionedPiece);
