...
module.exports.getPawnOptions = function(pieces, piece) {
    ...
    // nextMovPositions.x--
    let newLeftAttack = this.getPawAttack(pieces, nextMovPositions, positionInc )
...
module.exports.getPawAttack = function(pieces, piece, positionInc) {
    ...
    if (newColumn) {
        const newObj = this.createNewPieceByNotation(pieces,`${piece.name}@${piece.y + positionInc}`,piece.index)
