...
module.exports.getPawnOptions = function(pieces, piece) {
    ...
    // nextMovPositions.x--
    let newLeftAttack = this.getPawAttack(pieces,nextMovPositions, nextMovPositions.x -1 )
...
module.exports.getPawAttack = function(pieces, piece, xFactor) {
    const newColumn = this.getColumn(xFactor)
    console.log('NEW COLUMN', newColumn);
    // if (newColumn) {
    //     this.createNewPieceByNotation(pieces,`${piece.name}@${1}`,piece.index)
