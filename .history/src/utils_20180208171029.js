...
module.exports.getPawnOptions = function(piece, pieces){
    ...
    console.log('old position', piecePositions, pieces);
    // var newX = piecePositions.x + positionInc
    
    let newAttack = this.getPawAttack(piecePositions, piecePositions.x - 1)
...
module.exports.getPawAttack = function(newPiecePos, newX, pieces){
    ...
    if(newColumn){
        ...
        this.hasEnemyOnSquare(newObj, pieces)
        return newObj
    }
    return null
}

module.exports.hasEnemyOnSquare = function(piecePosition, pieces){
    console.log('positionInSquare', positionInSquare, piecePosition.square, pieces);
