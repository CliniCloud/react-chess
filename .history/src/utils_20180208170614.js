...
module.exports.hasEnemyOnSquare = function(piecePosition, piece){
    const positionInSquare = this.findPieceAtPosition(piecePosition.square)
    console.log('positionInSquare', positionInSquare);
}