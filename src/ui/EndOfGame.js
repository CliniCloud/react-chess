...
class EndOfGame extends React.Component {
    ...
    render(){
        ...
        if(this.props.isCheckmate){
            return endOfGameWrapper(<h2>Checkmate from <span style={{color:this.props.turn === 'B' ? '#d8d8d8' : 'black'}}>{this.props.turn === 'B' ? 'White' : 'Black'}</span></h2>);
        }else if(this.props.isStalemate){
            return endOfGameWrapper(<h2>Stalemate from <span style={{color:this.props.turn === 'B' ? '#d8d8d8' : 'black'}}>{this.props.turn === 'B' ? 'White' : 'Black'}</span></h2>);
